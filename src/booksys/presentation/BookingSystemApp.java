...
public class BookingSystemApp extends Frame
{
  ...
  public BookingSystemApp()
  {
    ...
    Menu WaitingList = new Menu("Waiting List") ;
    getMenuBar().add(WaitingList) ;
    
    MenuItem newWaiting = new MenuItem("Add New Waiting") ;
    newWaiting.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent e) {
	  ui.addWaitingList() ;
	}
      }) ;
    bookingMenu.add(newWaiting) ;

    MenuItem deleteWaiting = new MenuItem("Delete Waiting") ;
    newWalkIn.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent e) {
	  ui.deleteWaiting() ;
	}
      }) ;
    bookingMenu.add(deleteWaiting) ;

    MenuItem showWaiting = new MenuItem("Show Waiting") ;
    cancel.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent e) {
	  ui.showWaiting() ;
	}
      });
    bookingMenu.add(showWaiting) ;
