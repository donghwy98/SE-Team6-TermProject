...
class Restaurant
{
  ...
  WaitingListMapper wm = WaitingListMapper.getInstance();
  ...
  public WaitingList addWaitingList(Time time, String name, int wn) {
	  return wm.createWaitingList(time, wn, name);
  }
